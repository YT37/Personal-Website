        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {AWARDS.map((award, index) => (
            <motion.div
              ...
              className="relative bg-slate-900/80 p-6 rounded-lg flex items-start gap-4 transition-all duration-300 border border-white/10 hover:border-neon-accent hover:shadow-[0_0_15px_var(--color-neon-accent)] group overflow-hidden"
            >
